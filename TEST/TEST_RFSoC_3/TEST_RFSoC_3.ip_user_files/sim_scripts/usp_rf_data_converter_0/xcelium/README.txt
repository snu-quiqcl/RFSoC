...
#
# Generated by export_simulation on Wed Jan 18 09:39:24 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './usp_rf_data_converter_0.sh' script.

./usp_rf_data_converter_0.sh -reset_run
...
./usp_rf_data_converter_0.sh -noclean_files

For more information on the script, please type './usp_rf_data_converter_0.sh -help'.
