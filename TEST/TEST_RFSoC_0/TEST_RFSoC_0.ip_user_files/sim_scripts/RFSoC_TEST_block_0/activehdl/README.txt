...
#
# Generated by export_simulation on Tue Jan 17 16:58:39 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './RFSoC_TEST_block_0.sh' script.

./RFSoC_TEST_block_0.sh -reset_run
...
./RFSoC_TEST_block_0.sh -noclean_files

For more information on the script, please type './RFSoC_TEST_block_0.sh -help'.
