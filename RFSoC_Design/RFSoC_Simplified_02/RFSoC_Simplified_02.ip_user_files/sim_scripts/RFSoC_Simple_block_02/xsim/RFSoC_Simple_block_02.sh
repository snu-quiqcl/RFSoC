...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_8 -L zynq_ultra_ps_e_vip_v1_0_8 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L fifo_generator_v13_2_5 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RFSoC_Simple_block_02 xil_defaultlib.RFSoC_Simple_block_02 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RFSoC_Simple_block_02 -key {Behavioral:sim_1:Functional:RFSoC_Simple_block_02} -tclbatch cmd.tcl -protoinst "protoinst_files/RFSoC_Simple_block_02.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RFSoC_Simple_block_02.wdb xsim.dir)
