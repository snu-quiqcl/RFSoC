...
//Date        : Thu Feb 23 13:46:47 2023
//Host        : LAPTOP-ETOV1IS0 running 64-bit major release  (build 9200)
//Command     : generate_target RFSoC_Simple_block_02.bd
//Design      : RFSoC_Simple_block_02
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "RFSoC_Simple_block_02,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=RFSoC_Simple_block_02,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=4,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "RFSoC_Simple_block_02.hwdef" *) 
module RFSoC_Simple_block_02
   ();
  ...
  RFSoC_Simple_block_02_AXI2FIFO_0_0 AXI2FIFO_0
  ...
  RFSoC_Simple_block_02_RTO_Core0_0_0 RTO_Core0_0
       (.auto_start(1'b0),
  ...
  RFSoC_Simple_block_02_axi_interconnect_0_0 axi_interconnect_0
  ...
  RFSoC_Simple_block_02_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  RFSoC_Simple_block_02_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
...
module RFSoC_Simple_block_02_axi_interconnect_0_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  s00_couplers_imp_11JSBWS s00_couplers
...
module s00_couplers_imp_11JSBWS
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
