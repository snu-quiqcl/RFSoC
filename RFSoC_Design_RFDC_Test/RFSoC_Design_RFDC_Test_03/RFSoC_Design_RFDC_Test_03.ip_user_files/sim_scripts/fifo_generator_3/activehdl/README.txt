...
#
# Generated by export_simulation on Wed Mar 01 16:24:56 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './fifo_generator_3.sh' script.

./fifo_generator_3.sh -reset_run
...
./fifo_generator_3.sh -noclean_files

For more information on the script, please type './fifo_generator_3.sh -help'.
