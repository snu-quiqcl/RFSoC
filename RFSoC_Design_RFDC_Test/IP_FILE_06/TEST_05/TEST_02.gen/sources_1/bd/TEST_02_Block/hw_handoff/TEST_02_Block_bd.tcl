...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set RF3_CLKO_A_C_N [ create_bd_port -dir I -type clk -freq_hz 300000000 RF3_CLKO_A_C_N ]
  set RF3_CLKO_A_C_P [ create_bd_port -dir I -type clk -freq_hz 300000000 RF3_CLKO_A_C_P ]
