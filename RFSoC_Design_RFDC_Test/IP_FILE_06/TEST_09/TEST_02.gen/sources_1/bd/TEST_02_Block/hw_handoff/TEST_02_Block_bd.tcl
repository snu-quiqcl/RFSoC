...
################################################################
# This is a generated script based on design: TEST_02_Block
#
...
# source TEST_02_Block_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set DAC_Controller_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_Controller:1.0 DAC_Controller_1 ]
  ...
  connect_bd_intf_net -intf_net DAC_Controller_1_s00_axis [get_bd_intf_pins DAC_Controller_1/s00_axis] [get_bd_intf_pins usp_rf_data_converter_0/s10_axis]
  ...
  connect_bd_net -net DAC_Controller_0_dac0_nco_update_req [get_bd_ports DACIO_00] [get_bd_pins DAC_Controller_0/dac0_nco_update_req] [get_bd_pins usp_rf_data_converter_0/dac0_nco_update_req]
  connect_bd_net -net DAC_Controller_1_dac00_nco_freq [get_bd_pins DAC_Controller_1/dac00_nco_freq] [get_bd_pins usp_rf_data_converter_0/dac10_nco_freq]
  connect_bd_net -net DAC_Controller_1_dac00_nco_phase [get_bd_pins DAC_Controller_1/dac00_nco_phase] [get_bd_pins usp_rf_data_converter_0/dac10_nco_phase]
  connect_bd_net -net DAC_Controller_1_dac00_nco_phase_rst [get_bd_pins DAC_Controller_1/dac00_nco_phase_rst] [get_bd_pins usp_rf_data_converter_0/dac10_nco_phase_rst]
  connect_bd_net -net DAC_Controller_1_dac00_nco_update_en [get_bd_pins DAC_Controller_1/dac00_nco_update_en] [get_bd_pins usp_rf_data_converter_0/dac10_nco_update_en]
  connect_bd_net -net DAC_Controller_1_dac0_nco_update_req [get_bd_pins DAC_Controller_1/dac0_nco_update_req] [get_bd_pins usp_rf_data_converter_0/dac1_nco_update_req]
  connect_bd_net -net TimeController_0_auto_start [get_bd_pins DAC_Controller_0/auto_start] [get_bd_pins DAC_Controller_1/auto_start] [get_bd_pins TimeController_0/auto_start]
  connect_bd_net -net TimeController_0_counter [get_bd_pins DAC_Controller_0/counter] [get_bd_pins DAC_Controller_1/counter] [get_bd_pins TimeController_0/counter]
  connect_bd_net -net dac0_clk_n_0_1 [get_bd_ports RF3_CLKO_A_C_N] [get_bd_pins usp_rf_data_converter_0/dac0_clk_n] [get_bd_pins usp_rf_data_converter_0/dac1_clk_n]
  connect_bd_net -net dac0_clk_p_0_1 [get_bd_ports RF3_CLKO_A_C_P] [get_bd_pins usp_rf_data_converter_0/dac0_clk_p] [get_bd_pins usp_rf_data_converter_0/dac1_clk_p]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins DAC_Controller_0/s_axi_aresetn] [get_bd_pins DAC_Controller_1/s_axi_aresetn] [get_bd_pins TimeController_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s1_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_dac1_nco_update_busy [get_bd_pins DAC_Controller_1/dac0_nco_update_busy] [get_bd_pins usp_rf_data_converter_0/dac1_nco_update_busy]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins DAC_Controller_0/s00_axis_aclk] [get_bd_pins DAC_Controller_0/s_axi_aclk] [get_bd_pins DAC_Controller_1/s00_axis_aclk] [get_bd_pins DAC_Controller_1/s_axi_aclk] [get_bd_pins TimeController_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DAC_Controller_1/s_axi/reg0] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs TimeController_0/s_axi/reg0] -force
