...
HD_PWD='E:/RFSoC/GIT/RFSoC/RFSoC_Design_RFDC_Test/IP_FILE_06/TEST_07/TEST_02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_02_Block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TEST_02_Block_wrapper.tcl -notrace
