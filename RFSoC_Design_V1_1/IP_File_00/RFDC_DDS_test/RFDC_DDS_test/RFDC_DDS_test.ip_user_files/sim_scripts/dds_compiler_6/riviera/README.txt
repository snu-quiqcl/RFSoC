...
#
# Generated by export_simulation on Sat Aug 26 17:15:46 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './dds_compiler_6.sh' script.

./dds_compiler_6.sh -reset_run
...
./dds_compiler_6.sh -noclean_files

For more information on the script, please type './dds_compiler_6.sh -help'.
