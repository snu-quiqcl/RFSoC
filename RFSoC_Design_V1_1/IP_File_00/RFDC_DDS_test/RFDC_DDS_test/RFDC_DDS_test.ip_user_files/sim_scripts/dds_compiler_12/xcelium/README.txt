...
#
# Generated by export_simulation on Sat Aug 26 17:15:11 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './dds_compiler_12.sh' script.

./dds_compiler_12.sh -reset_run
...
./dds_compiler_12.sh -noclean_files

For more information on the script, please type './dds_compiler_12.sh -help'.
