...
#
# Generated by export_simulation on Sat Aug 26 17:15:29 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './dds_compiler_9.sh' script.

./dds_compiler_9.sh -reset_run
...
./dds_compiler_9.sh -noclean_files

For more information on the script, please type './dds_compiler_9.sh -help'.
