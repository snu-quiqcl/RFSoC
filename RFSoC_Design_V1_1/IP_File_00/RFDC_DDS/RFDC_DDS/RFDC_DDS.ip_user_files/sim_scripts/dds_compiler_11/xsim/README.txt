...
#
# Generated by export_simulation on Fri Aug 25 18:07:51 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './dds_compiler_11.sh' script.

./dds_compiler_11.sh -reset_run
...
./dds_compiler_11.sh -noclean_files

For more information on the script, please type './dds_compiler_11.sh -help'.
