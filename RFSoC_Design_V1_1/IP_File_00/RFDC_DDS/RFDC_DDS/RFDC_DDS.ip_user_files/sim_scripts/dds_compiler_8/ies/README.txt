...
#
# Generated by export_simulation on Fri Aug 25 18:08:07 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './dds_compiler_8.sh' script.

./dds_compiler_8.sh -reset_run
...
./dds_compiler_8.sh -noclean_files

For more information on the script, please type './dds_compiler_8.sh -help'.
