...
HD_PWD='E:/RFSoC/GIT/RFSoC/RFSoC_Design_V1_1/IP_File_00/RFSoC_Main_test/RFSoC_Main_test/RFSoC_Main_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RFSoC_Main_test_blk_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RFSoC_Main_test_blk_wrapper.tcl -notrace
