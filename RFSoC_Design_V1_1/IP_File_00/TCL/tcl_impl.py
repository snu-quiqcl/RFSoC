...
def get_all_files_in_directory(directory):
    ...
    for root, dirs, files in os.walk(directory):
        for file in files:
            if file.endswith(".xci") or file.endswith(".sv") or file.endswith(".v"):
...
def make_tcl(folder_directory,prj_name,part_name,board_path,board_name):
    ...
    tcl_code += '\n'
    tcl_code += add_src(folder_directory)
    tcl_code += '\n'
...
def add_src(folder_directory):
    # Get all files in the directory
    all_files = get_all_files_in_directory(folder_directory)
...
if __name__ == "__main__":
    ...
    make_tcl(folder_directory,prj_name,part_name,board_path,board_name)
