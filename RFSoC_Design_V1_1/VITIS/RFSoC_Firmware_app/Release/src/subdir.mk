...
src/clock_config.o: E:/RFSoC/GIT/Vivado_prj_manager/Vitis_main/RFSoC_Firmware/clock_config.c
	...
	aarch64-none-elf-gcc -Wall -O2 -c -fmessage-length=0 -MT"$@" -D __BAREMETAL__ -IE:/RFSoC/GIT/RFSoC/RFSoC_Design_V1_1/VITIS/RFSoC_Firmware_plt/export/RFSoC_Firmware_plt/sw/RFSoC_Firmware_plt/standalone_domain/bspinclude/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
