...
xilinx.com:user:TTL_out:1.0\
xilinx.com:user:TTLx8_out:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: TTL_out_0, and set properties
  set TTL_out_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:TTL_out:1.0 TTL_out_0 ]
  set_property -dict [ list \
   CONFIG.DATA_LEN {1} \
   CONFIG.DEPTH {512} \
   CONFIG.THRESHOLD {504} \
 ] $TTL_out_0

  # Create instance: TTL_out_1, and set properties
  set TTL_out_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:TTL_out:1.0 TTL_out_1 ]
  set_property -dict [ list \
   CONFIG.DATA_LEN {1} \
   CONFIG.DEPTH {512} \
   CONFIG.THRESHOLD {504} \
  ...
  # Create instance: TTLx8_out_0, and set properties
  set TTLx8_out_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:TTLx8_out:1.0 TTLx8_out_0 ]
  set_property -dict [ list \
   CONFIG.ADDR_LEN {8} \
   CONFIG.DATA_LEN {8} \
   CONFIG.DEPTH {256} \
   CONFIG.THRESHOLD {248} \
 ] $TTLx8_out_0

  # Create instance: TTLx8_out_1, and set properties
  set TTLx8_out_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:TTLx8_out:1.0 TTLx8_out_1 ]
  set_property -dict [ list \
   CONFIG.ADDR_LEN {8} \
   CONFIG.DATA_LEN {8} \
   CONFIG.DEPTH {256} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins TTLx8_out_0/s_axi] [get_bd_intf_pins axi_interconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins TTLx8_out_1/s_axi] [get_bd_intf_pins axi_interconnect_0/M04_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins TTL_out_0/s_axi] [get_bd_intf_pins axi_interconnect_0/M05_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins TTL_out_1/s_axi] [get_bd_intf_pins axi_interconnect_0/M06_AXI]
  ...
  connect_bd_net -net RF3_CLKO_A_C_N_2 [get_bd_ports RF3_CLKO_A_C_N_229]
  connect_bd_net -net RF3_CLKO_A_C_P_1 [get_bd_ports RF3_CLKO_A_C_P_228] [get_bd_pins usp_rf_data_converter_0/dac0_clk_p]
  connect_bd_net -net RF3_CLKO_A_C_P_2 [get_bd_ports RF3_CLKO_A_C_P_229]
  connect_bd_net -net TTL_out_0_output_pulse [get_bd_ports GPIO_LED_0_LS] [get_bd_pins TTL_out_0/output_pulse]
  connect_bd_net -net TTL_out_1_output_pulse [get_bd_ports GPIO_LED_1_LS] [get_bd_pins TTL_out_1/output_pulse]
  connect_bd_net -net TTLx8_out_0_output_pulse [get_bd_ports FMCP_HSPC_LA10_P] [get_bd_pins TTLx8_out_0/output_pulse]
  connect_bd_net -net TTLx8_out_1_output_pulse [get_bd_ports FMCP_HSPC_LA10_N] [get_bd_pins TTLx8_out_1/output_pulse]
  connect_bd_net -net TimeController_0_auto_start [get_bd_pins DAC_Controller_0/auto_start] [get_bd_pins TTL_out_0/auto_start] [get_bd_pins TTL_out_1/auto_start] [get_bd_pins TTLx8_out_0/auto_start] [get_bd_pins TTLx8_out_1/auto_start] [get_bd_pins TimeController_0/auto_start]
  connect_bd_net -net TimeController_0_counter [get_bd_pins DAC_Controller_0/counter] [get_bd_pins TTL_out_0/counter] [get_bd_pins TTL_out_1/counter] [get_bd_pins TTLx8_out_0/counter] [get_bd_pins TTLx8_out_1/counter] [get_bd_pins TimeController_0/counter]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins TTLx8_out_0/clk_x4] [get_bd_pins TTLx8_out_1/clk_x4] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins DAC_Controller_0/s_axi_aresetn] [get_bd_pins TTL_out_0/s_axi_aresetn] [get_bd_pins TTL_out_1/s_axi_aresetn] [get_bd_pins TTLx8_out_0/s_axi_aresetn] [get_bd_pins TTLx8_out_1/s_axi_aresetn] [get_bd_pins TimeController_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins DAC_Controller_0/m00_axis_aclk] [get_bd_pins DAC_Controller_0/s_axi_aclk] [get_bd_pins TTL_out_0/s_axi_aclk] [get_bd_pins TTL_out_1/s_axi_aclk] [get_bd_pins TTLx8_out_0/s_axi_aclk] [get_bd_pins TTLx8_out_1/s_axi_aclk] [get_bd_pins TimeController_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0020000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs TTL_out_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0021000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs TTL_out_1/s_axi/reg0] -force
