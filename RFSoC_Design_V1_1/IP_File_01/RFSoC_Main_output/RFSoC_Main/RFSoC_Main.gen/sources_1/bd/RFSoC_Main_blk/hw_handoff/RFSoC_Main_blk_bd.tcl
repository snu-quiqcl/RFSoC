...
################################################################
# This is a generated script based on design: RFSoC_Main_blk
#
...
# source RFSoC_Main_blk_script.tcl
...
set design_name RFSoC_Main_blk
...
proc create_root_design { parentCell } {
  ...
  set RFMC_DAC_04_N [ create_bd_port -dir O RFMC_DAC_04_N ]
  set RFMC_DAC_04_P [ create_bd_port -dir O RFMC_DAC_04_P ]
  set RFMC_DAC_05_N [ create_bd_port -dir O RFMC_DAC_05_N ]
  set RFMC_DAC_05_P [ create_bd_port -dir O RFMC_DAC_05_P ]
  set RFMC_DAC_06_N [ create_bd_port -dir O RFMC_DAC_06_N ]
  set RFMC_DAC_06_P [ create_bd_port -dir O RFMC_DAC_06_P ]
  set RFMC_DAC_07_N [ create_bd_port -dir O RFMC_DAC_07_N ]
  set RFMC_DAC_07_P [ create_bd_port -dir O RFMC_DAC_07_P ]

  # Create instance: DAC_Controller_0, and set properties
  set DAC_Controller_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_Controller_0:1.0 DAC_Controller_0 ]

  # Create instance: DAC_Controller_1, and set properties
  set DAC_Controller_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_Controller_1:1.0 DAC_Controller_1 ]

  # Create instance: DAC_Controller_2, and set properties
  set DAC_Controller_2 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_Controller_2:1.0 DAC_Controller_2 ]

  # Create instance: DAC_Controller_3, and set properties
  set DAC_Controller_3 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_Controller_3:1.0 DAC_Controller_3 ]

  # Create instance: DAC_Controller_4, and set properties
  set DAC_Controller_4 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_Controller_4:1.0 DAC_Controller_4 ]

  # Create instance: DAC_Controller_5, and set properties
  set DAC_Controller_5 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_Controller_5:1.0 DAC_Controller_5 ]

  # Create instance: DAC_Controller_6, and set properties
  set DAC_Controller_6 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_Controller_6:1.0 DAC_Controller_6 ]

  # Create instance: DAC_Controller_7, and set properties
  set DAC_Controller_7 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_Controller_7:1.0 DAC_Controller_7 ]

  # Create instance: TimeControllerBuffer_0, and set properties
  set TimeControllerBuffer_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:TimeControllerBuffer:1.0 TimeControllerBuffer_0 ]

  # Create instance: TimeControllerBuffer_1, and set properties
  set TimeControllerBuffer_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:TimeControllerBuffer:1.0 TimeControllerBuffer_1 ]

  # Create instance: TimeControllerBuffer_2, and set properties
  set TimeControllerBuffer_2 [ create_bd_cell -type ip -vlnv xilinx.com:user:TimeControllerBuffer:1.0 TimeControllerBuffer_2 ]
  ...
  connect_bd_net -net TimeControllerBuffer_1_auto_start0_O [get_bd_pins DAC_Controller_0/auto_start] [get_bd_pins TimeControllerBuffer_1/auto_start0_O]
  connect_bd_net -net TimeControllerBuffer_1_auto_start1_O [get_bd_pins DAC_Controller_1/auto_start] [get_bd_pins TimeControllerBuffer_1/auto_start1_O]
  connect_bd_net -net TimeControllerBuffer_1_auto_start2_O [get_bd_pins DAC_Controller_2/auto_start] [get_bd_pins TimeControllerBuffer_1/auto_start2_O]
  connect_bd_net -net TimeControllerBuffer_1_auto_start3_O [get_bd_pins DAC_Controller_3/auto_start] [get_bd_pins TimeControllerBuffer_1/auto_start3_O]
  connect_bd_net -net TimeControllerBuffer_1_counter0_O [get_bd_pins DAC_Controller_0/counter] [get_bd_pins TimeControllerBuffer_1/counter0_O]
  connect_bd_net -net TimeControllerBuffer_1_counter1_O [get_bd_pins DAC_Controller_1/counter] [get_bd_pins TimeControllerBuffer_1/counter1_O]
  connect_bd_net -net TimeControllerBuffer_1_counter2_O [get_bd_pins DAC_Controller_2/counter] [get_bd_pins TimeControllerBuffer_1/counter2_O]
  connect_bd_net -net TimeControllerBuffer_1_counter3_O [get_bd_pins DAC_Controller_3/counter] [get_bd_pins TimeControllerBuffer_1/counter3_O]
  connect_bd_net -net TimeControllerBuffer_2_auto_start0_O [get_bd_pins DAC_Controller_4/auto_start] [get_bd_pins TimeControllerBuffer_2/auto_start0_O]
  connect_bd_net -net TimeControllerBuffer_2_auto_start1_O [get_bd_pins DAC_Controller_5/auto_start] [get_bd_pins TimeControllerBuffer_2/auto_start1_O]
  connect_bd_net -net TimeControllerBuffer_2_auto_start2_O [get_bd_pins DAC_Controller_6/auto_start] [get_bd_pins TimeControllerBuffer_2/auto_start2_O]
  connect_bd_net -net TimeControllerBuffer_2_auto_start3_O [get_bd_pins DAC_Controller_7/auto_start] [get_bd_pins TimeControllerBuffer_2/auto_start3_O]
  connect_bd_net -net TimeControllerBuffer_2_counter0_O [get_bd_pins DAC_Controller_4/counter] [get_bd_pins TimeControllerBuffer_2/counter0_O]
  connect_bd_net -net TimeControllerBuffer_2_counter1_O [get_bd_pins DAC_Controller_5/counter] [get_bd_pins TimeControllerBuffer_2/counter1_O]
  connect_bd_net -net TimeControllerBuffer_2_counter2_O [get_bd_pins DAC_Controller_6/counter] [get_bd_pins TimeControllerBuffer_2/counter2_O]
  connect_bd_net -net TimeControllerBuffer_2_counter3_O [get_bd_pins DAC_Controller_7/counter] [get_bd_pins TimeControllerBuffer_2/counter3_O]
