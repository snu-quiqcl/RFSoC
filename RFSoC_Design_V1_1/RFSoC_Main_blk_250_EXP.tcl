...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:AXI_Buffer:1.0\
xilinx.com:user:DAC_Controller_0:1.0\
xilinx.com:user:DAC_Controller_1:1.0\
xilinx.com:user:DAC_Controller_2:1.0\
xilinx.com:user:DAC_Controller_3:1.0\
xilinx.com:user:DAC_Controller_4:1.0\
xilinx.com:user:DAC_Controller_5:1.0\
xilinx.com:user:DAC_Controller_6:1.0\
xilinx.com:user:DAC_Controller_7:1.0\
...
proc create_root_design { parentCell } {
  ...
  set m00_axis_01 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m00_axis_01 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {249997498} \
   ] $m00_axis_01

  set m00_axis_02 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m00_axis_02 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {249997498} \
   ] $m00_axis_02

  set m00_axis_03 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m00_axis_03 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {249997498} \
   ] $m00_axis_03

  set m00_axis_04 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m00_axis_04 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {249997498} \
   ] $m00_axis_04

  set m00_axis_05 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m00_axis_05 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {249997498} \
   ] $m00_axis_05

  set m00_axis_06 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m00_axis_06 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {249997498} \
   ] $m00_axis_06

  set m00_axis_07 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m00_axis_07 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {249997498} \
   ] $m00_axis_07
  ...
  set AXI_Buffer_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_Buffer:1.0 AXI_Buffer_0 ]
  ...
  connect_bd_intf_net -intf_net DAC_Controller_1_m00_axis [get_bd_intf_ports m00_axis_01] [get_bd_intf_pins DAC_Controller_1/m00_axis]
  connect_bd_intf_net -intf_net DAC_Controller_2_m00_axis [get_bd_intf_ports m00_axis_02] [get_bd_intf_pins DAC_Controller_2/m00_axis]
  connect_bd_intf_net -intf_net DAC_Controller_3_m00_axis [get_bd_intf_ports m00_axis_03] [get_bd_intf_pins DAC_Controller_3/m00_axis]
  connect_bd_intf_net -intf_net DAC_Controller_4_m00_axis [get_bd_intf_ports m00_axis_04] [get_bd_intf_pins DAC_Controller_4/m00_axis]
  connect_bd_intf_net -intf_net DAC_Controller_5_m00_axis [get_bd_intf_ports m00_axis_05] [get_bd_intf_pins DAC_Controller_5/m00_axis]
  connect_bd_intf_net -intf_net DAC_Controller_6_m00_axis [get_bd_intf_ports m00_axis_06] [get_bd_intf_pins DAC_Controller_6/m00_axis]
  connect_bd_intf_net -intf_net DAC_Controller_7_m00_axis [get_bd_intf_ports m00_axis_07] [get_bd_intf_pins DAC_Controller_7/m00_axis]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces AXI_Buffer_0/m_axi] [get_bd_addr_segs DAC_Controller_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces AXI_Buffer_0/m_axi] [get_bd_addr_segs DAC_Controller_1/s_axi/reg0] -force
  assign_bd_address -offset 0xA0002000 -range 0x00001000 -target_address_space [get_bd_addr_spaces AXI_Buffer_0/m_axi] [get_bd_addr_segs DAC_Controller_2/s_axi/reg0] -force
  assign_bd_address -offset 0xA0003000 -range 0x00001000 -target_address_space [get_bd_addr_spaces AXI_Buffer_0/m_axi] [get_bd_addr_segs DAC_Controller_3/s_axi/reg0] -force
  assign_bd_address -offset 0xA0004000 -range 0x00001000 -target_address_space [get_bd_addr_spaces AXI_Buffer_0/m_axi] [get_bd_addr_segs DAC_Controller_4/s_axi/reg0] -force
  assign_bd_address -offset 0xA0005000 -range 0x00001000 -target_address_space [get_bd_addr_spaces AXI_Buffer_0/m_axi] [get_bd_addr_segs DAC_Controller_5/s_axi/reg0] -force
  assign_bd_address -offset 0xA0006000 -range 0x00001000 -target_address_space [get_bd_addr_spaces AXI_Buffer_0/m_axi] [get_bd_addr_segs DAC_Controller_6/s_axi/reg0] -force
  assign_bd_address -offset 0xA0007000 -range 0x00001000 -target_address_space [get_bd_addr_spaces AXI_Buffer_0/m_axi] [get_bd_addr_segs DAC_Controller_7/s_axi/reg0] -force
